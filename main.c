...
/*   Updated: 2026/02/03 17:03:00 by gblas-he         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	test_strchr(void)
{
	...
	str = " apateros a tu apazto azpatos ";
...
void	test_strmapi(void)
{
	...
	res = ft_strmapi(s, mapi_to_upper_even);
	printf("%s\n", res);
	free(res);
}
...
void	test_strtrim(void)
{
	...
	str = "ztztapateros a tu apazto apatosztztz";
...
void	test_strrchr(void)
{
	...
	str = " apatberos a tu apazto azpbatos ";
...
void	test_memchr(void)
{
	...
	str = "apateros a tu apazto apatos";
